      ...
      <div className="flex-1 flex items-center justify-center px-8 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm space-y-8 animate-slide-up">
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-2 group">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4 group-focus-within:text-orange-500 transition-colors">Họ và tên</label>
                <div className="relative">
                  <User className="absolute left-6 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-300 group-focus-within:text-orange-500 transition-colors" />
                  <input 
                    type="text" 
              ...
              <div className="space-y-2 group">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4 group-focus-within:text-orange-500 transition-colors">Địa chỉ Email</label>
                <div className="relative">
              ...
              <div className="space-y-2 group">
                 <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4 group-focus-within:text-orange-500 transition-colors">Mật khẩu</label>
                <div className="relative">
          ...
          <p className="text-center text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-6">
            Trở lại <Link href="/auth/signin" className="text-orange-600 hover:underline cursor-pointer transition-all hover:tracking-[0.15em]">Đăng nhập</Link>
          </p>
        </div>
      </div>
    </div>
