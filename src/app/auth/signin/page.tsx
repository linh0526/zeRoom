...
import { Chrome, Mail, Lock, ChevronRight, ArrowLeft, Loader2 } from "lucide-react";
...
export default function SignInPage() {
  ...
  const handleCredentialsLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        toast.error("Email hoặc mật khẩu không chính xác", { id: loadingToast });
      } else {
      ...
      <div className="flex-1 flex items-center justify-center px-8 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm space-y-10 animate-slide-up">
          <div className="space-y-3">
            <h2 className="text-4xl font-black text-gray-900 tracking-tight">Chào bạn!</h2>
            <p className="text-gray-500 font-medium italic">Đăng nhập để bắt đầu đăng tin và quản lý bài viết.</p>
          </div>
