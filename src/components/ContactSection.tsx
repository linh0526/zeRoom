    ...
    <div className="space-y-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <a href="https://www.facebook.com/nguyen.hoai.linh.96331" target="_blank" rel="noopener noreferrer" className="text-base font-semibold text-gray-900 hover:text-blue-600 transition-colors">Nguyen Hoai Linh</a>
                  </div>
                </div>
                <div className="flex gap-5">
        ...
        <div className="lg:sticky lg:top-10 h-fit">
          <form onSubmit={handleSubmit} className="bg-white rounded-[48px] p-10 border border-gray-100 shadow-2xl shadow-blue-100/30 space-y-8">
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <input 
                  ...
                  className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-medium text-gray-900 focus:bg-white focus:border-blue-500 outline-none transition-all" 
                />
                <input 
                  type="tel" 
              ...
              <textarea 
                ...
                className="w-full px-6 py-4 bg-gray-50 border border-transparent rounded-3xl text-sm font-medium text-gray-900 focus:bg-white focus:border-blue-500 outline-none transition-all resize-none"
              ></textarea>
              
              <button 
                type="submit"
                disabled={loading}
                className="w-full py-5 bg-blue-600 text-white rounded-[24px] font-bold text-lg hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-200 transition-all active:scale-[0.98] shadow-lg shadow-blue-100 flex items-center justify-center gap-3 group disabled:opacity-50"
              >
